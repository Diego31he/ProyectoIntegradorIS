...
@Route(value = "admin/participantes", layout = AdminLayout.class) // <-- Layout de Admin
@RolesAllowed("ROLE_ADMIN")
public class ParticipantesAdminView extends VerticalLayout {

    private final Grid<Usuario> grid = new Grid<>(Usuario.class);

    @Autowired
    public ParticipantesAdminView(UsuarioAdminService usuarioService) {
        setSizeFull();
        setPadding(true);
